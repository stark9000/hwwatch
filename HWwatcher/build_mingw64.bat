@echo off
REM Builds hwwatch64.dll using E:\msys64\mingw64
...
where gcc >nul 2>nul
if %ERRORLEVEL% NEQ 0 (
    echo ERROR: gcc not found on PATH after adding E:\msys64\mingw64\bin
    echo Check that E:\msys64\mingw64\bin\gcc.exe actually exists.
    pause
    exit /b 1
)

gcc -m64 -shared -O2 -Wall ^
    -I"%JAVA_HOME%\include" -I"%JAVA_HOME%\include\win32" ^
    -o hwwatch64.dll hwwatcher.c ^
